      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-2xl font-bold">Form Tambah Unit</h2>
        ...
        <div
          v-if="successMessage"
          class="mx-8 mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg"
        >
        ...
        <form @submit.prevent="handleSubmit" class="p-8 space-y-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-2">
              Contoh: Divisi IT, Bagian Keuangan, dll
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p class="text-xs text-gray-500 mt-2">
              Kode unik untuk identifikasi unit
            </p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all outline-none"
            >
              <option :value="null">-- Tidak Ada Parent (Unit Utama) --</option>
              <option
            ...
            <label class="flex items-start gap-4 cursor-pointer">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Centang jika unit kerja ini aktif dan beroperasi
                </p>
              </div>
            </label>
          </div>
...
// Fetch daftar unit untuk dropdown parent
...
const handleSubmit = async () => {
  ...
  try {
    ...
    successMessage.value = "Unit berhasil ditambahkan!";
    ...
    errorMessage.value =
      error.response?.data?.message || "Gagal menambahkan unit baru.";
  } finally {
